...
/**
 * Écrit une case, puis emmène au récapitulatif.
 *
 ...
 *
 * Le refus n'a pas encore d'écran — la valeur arrivée se lit au récapitulatif,
 * qui montre l'état vrai. L'écran qui rend un refus lisible et réapplique la
 * valeur tapée est son propre ticket.
 *
